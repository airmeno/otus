...
Данное решение по сути возвращает размещение файлов на места по умолчанию, что соответствует контексту безопасности SELinux для Bind (named).
...
Теперь сервер настроен правильно и клиент может выполнять поставленную задачу. 
