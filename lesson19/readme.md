...
Имеет структуру дерикторий которую мы создали для удобства сборки:
...
Чтоб убедиться, что сайт находится в нашей директории code, изменим содержание строки NGINX SERVER IN ALPINE => NGINX +PHP SERVER IN ALPINE
