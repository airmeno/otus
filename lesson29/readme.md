...
```
Хост машина: порт 8888 => inetRouter2: 192.168.50.2:8080 => inetRouter2: 192.168.10.20:80 => centralRouter => centralServer 192.168.10.20:80
```
Подробнее об алгоритме прохождения в п.4
...
Для всех хостов закрыт маршрут по умолчанию создаваемый вагрант и прописан свой маршрут:
